...
import { fetchBookingsForStarting } from "../../api/MentorBookingApi.jsx";

export const ExistingBookings = ({ mentorId }) => {
    const [existingBookings, setExistingBookings] = useState([]);
    const [bookingFilter, setBookingFilter] = useState('all');
    const [searchTerm, setSearchTerm] = useState('');

    useEffect(() => {
        fetchBookingsForStarting(mentorId).then(setExistingBookings);
    }, [mentorId]);
