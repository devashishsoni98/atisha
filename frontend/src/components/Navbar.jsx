...
// import { FaBell, FaBars, FaTimes, FaUser, FaChevronDown, FaChevronUp, FaLanguage } from "react-icons/fa";
...
//     try {
//       const response = await apibackend.post(`/notifications/${notificationId}/mark-as-read`);
//       if (!response) {
...
//                   <div key={notification.id} className={`mb-4 p-3 rounded-lg border-l-4 ${getCategoryColor(notification.category)} relative`}>
//                     {notification.link ? (
//                       <Link to={notification.link} className="block" onClick={() => markNotificationAsRead(notification.id)}>
