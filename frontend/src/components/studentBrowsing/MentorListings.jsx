                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-grow">
                        ...
                        <div className="flex flex-wrap gap-2 mb-2">
                            <span className="text-xs px-2 py-1 bg-gray-200 rounded-full">{mentor.expertise}</span>
                        </div>
                        <p className="text-sm text-gray-600">Experience: {mentor.mentor_professional[0].year_of_experience} years</p>
                        {/*{mentor.certifications && mentor.certifications.length > 0 && (*/}
                        {/*    <div className="mt-2">*/}
                        {/*        <p className="text-sm font-medium">Certifications:</p>*/}
                        {/*        <ul className="list-disc list-inside">*/}
                        {/*            {mentor.certifications.map((cert, index) => (*/}
                        {/*                <li key={index} className="text-xs text-blue-600 truncate">*/}
                ...
                {selectedMentor ? (
                    ...
                    <div className="flex items-center justify-center h-full bg-gray-200 rounded-lg p-6">
                        <p className="text-gray-600 text-center">
                            Select a mentor to view available time slots and book an appointment.
                        </p>
                    </div>
                )}
            </section>
