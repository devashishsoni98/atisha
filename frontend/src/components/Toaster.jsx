...
const Toaster = ({ message, type, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className={`flex items-center w-full max-w-xs p-4 mb-4 rounded-xl shadow-lg bg-white border-[3px] ${colors[type]}`}
      role="alert"
    >
...
//   return (
//     <div className="fixed top-5 left-1/2 transform -translate-x-1/2 flex flex-col items-center z-50">
//       <AnimatePresence>
//         {toasts.map((toast) => (
//           <Toast
//             key={toast.id}
