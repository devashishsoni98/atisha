...
//     return (
//         <motion.div className="h-auto md:min-h-screen " initial="initial" animate="animate" exit="exit"
//                     variants={fadeIn}>
//             <div className="flex flex-col lg:flex-row">
//                 {/* Sidebar for both Mobile and Desktop */}
//                 <motion.div
//                     className="w-full md:min-h-screen lg:w-64 bg-white shadow-lg"
//                     variants={slideIn}
//                 >
//                     {/* Mobile Header */}
...
//                         />
//                         <h2 className="text-xl font-bold text-blue-500 text-center">{studentData?.name}</h2>
...
//                         >
//                             {['Profile', 'Interest', 'Session', 'Events', 'Activities'].map((tab) => (
//                                 <motion.button
//                                     key={tab}
//                                     data-tab={tab}
...
//                                 <p>
//                                     <strong>Time:</strong> {formatTime(report.counselor_bookings.start_time)} - {formatTime(report.counselor_bookings.end_time)}
//                                 </p>
...
import { useCommonFunctions } from '../../utils/commonFunctions';
import axios from 'axios';
import { User, Mail, Calendar, MapPin, Phone, School, GraduationCap, LogOut, Bell, Home, LineChart, Package, Package2, Search, ShoppingCart, Users, Star, CheckCircle, Circle, CalendarDays } from 'lucide-react';
...
const DashboardStudent = () => {
    ...
    return (
        <motion.div className="h-auto md:min-h-screen bg-gray-100" initial="initial" animate="animate" exit="exit" variants={fadeIn}>
            <div className="flex flex-col lg:flex-row">
                {/* Sidebar for both Mobile and Desktop */}
                <motion.div className="w-full md:min-h-screen lg:w-64 bg-white shadow-lg" variants={slideIn}>
                    {/* Mobile Header */}
                    <div className="lg:hidden bg-blue-500 p-6">
                        <div className="relative h-24 mb-16">
                            <img
                    ...
                    <div className="p-6">
                        ...
                        <nav
                            ...
                            className="flex lg:flex-col overflow-x-auto lg:overflow-x-visible whitespace-nowrap lg:whitespace-normal scrollbar-hide"
                        >
                            {['Overview', 'Profile', 'Interest', 'Session', 'Events', 'Activities'].map((tab) => (
                                <motion.button
                                    key={tab}
                                    data-tab={tab}
                                    onClick={() => setActiveTab(tab)}
            ...
            <motion.div className="bg-white shadow-lg rounded-2xl overflow-hidden" variants={slideIn}>
                <div className="p-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <ProfileItem icon={<Mail className="text-blue-500"/>} label="Email" value={studentData.email}/>
                        <ProfileItem icon={<Calendar className="text-blue-500"/>} label="Date of Birth" value={new Date(studentData.student_personal_info.dob).toLocaleDateString()}/>
                        <ProfileItem icon={<User className="text-blue-500"/>} label="Gender" value={studentData.student_personal_info.gender}/>
                        <ProfileItem icon={<MapPin className="text-blue-500"/>} label="Location" value={studentData.student_personal_info.location}/>
                        <ProfileItem icon={<Phone className="text-blue-500"/>} label="Contact Number" value={studentData.student_personal_info.contact_number}/>
                        <ProfileItem icon={<School className="text-blue-500"/>} label="School Name" value={studentData.student_education.school_name}/>
                        <ProfileItem icon={<GraduationCap className="text-blue-500"/>} label="Class" value={studentData.student_education.class.toString()}/>
                    </div>
                </div>
            </motion.div>
        </motion.div>
    ...
    return (
        <motion.div className="space-y-6" initial="initial" animate="animate" exit="exit" variants={fadeIn}>
            <motion.div className="bg-white rounded-2xl p-6 shadow-md" variants={slideIn}>
                <div className="flex justify-between items-center mb-6">
                    <motion.h2 className="text-2xl font-bold text-blue-800" variants={fadeIn}>Your Sessions</motion.h2>
                    <Link to="/student-browsing" className="bg-blue-600 hover:bg-blue-800 text-white py-2 px-4 rounded-xl transition-colors">
                        Book New Session
                    </Link>
                </div>
                ...
                setEvents([
                    {
                        ...
                        "event_mode": "offline",
                        "organizer_id": 2,
                        "created_at": "2024-11-27T10:57:06.908Z","city": "Jaipur",
                        "state": "Rajasthan"
                    },
                    {
                        "id": 2,
