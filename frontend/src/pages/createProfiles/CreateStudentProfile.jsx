...
//     setOtherSubjects([...otherSubjects, formData.otherSubject]);
//     setFormData((prev) => ({ ...prev, otherSubject:"" }));
//   };

//   const handleAddOtherSport = () => {
//     setOtherSports([...otherSports, formData.otherSport]);
//     setFormData((prev) => ({ ...prev, otherSport:"" }));
//   };

//   const handleAddOtherHobby = () => {
//     setOtherHobbies([...otherHobbies, formData.otherHobby]);
//     setFormData((prev) => ({ ...prev, otherHobby:"" }));
//   };
