...
//     // Check if career specialization is provided when counselor specialty is career
...
//         certificates: [], // Handle certificate uploads separately as needed
//         counselor_type: formData.counselor_type,
//         counselor_speciality: formData.counselor_speciality,
//         career_specialization: formData.counselor_speciality === 'career' ? formData.career_specialization.split(',').map(item => item.trim()) : [],
//       };
...
//                 <input id="degree_image" name="degree_image" type="file" onChange={handleInputChange} accept=".jpg,.jpeg,.png" required />
//               </div>
...
//                 <input id= "year_of_experience" name= "year_of_experience" type= "number" value= {formData.year_of_experience} onChange= {handleInputChange} min= "0" required /> 
//               </div> 

//               {/* Counselor Type Dropdown */}
//               <div>
//                 <label htmlFor="counselor_type" className="block text-sm font-medium text-gray-700 mb-1">Counselor Type</label>
//                 <select id="counselor_type" name="counselor_type" value={formData.counselor_type} onChange={handleInputChange} required>
...
//               {/* Counselor Speciality Dropdown */}
//               <div>
//                 <label htmlFor="counselor_speciality" className="block text-sm font-medium text-gray-700 mb-1">Counselor Speciality</label>
//                 <select id="counselor_speciality" name="counselor_speciality" value={formData.counselor_speciality} onChange={handleInputChange} required>
...
//                 {/* Conditional rendering for Career Specialization */}
...
//             {/* Bio Input */}
//             {/* You can add a similar input for certificates as needed */}
//             {/* Bio Input */}
...
//          {/* Form Header */}
//          <h2 className="text-xl font-bold leading-tight text-center py-4">Create Counselor Profile</h2>
...
//                className={`px-4 py-2 mx-auto my-auto rounded-lg transition duration-300 ease-in-out ${
...
//            {renderTabContent()}
//            {/* Submit Button */}
//            <button type='submit' className='mt-4 w-full py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700'>
//              {activeTab === tabs[tabs.length - 1] ? 'Submit' : 'Next'}
//            </button>

//            {/* Previous Button */}
//            {activeTab !== tabs[0] && (
//              <button type='button' onClick={handlePrevious} className='mt-2 w-full py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700'>
//                Previous
//              </button>
//            )}
//          </form>
...
import { User, Mail, Calendar, MapPin, Phone, School, GraduationCap, Award, Briefcase, Heart, LogOut } from 'lucide-react';
import axios from 'axios';
        ...
        <motion.div className="flex-1 p-8" variants={fadeIn}>
          <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <h2 className="text-2xl font-bold leading-tight text-center py-4 text-blue-800">Create Counselor Profile</h2>
