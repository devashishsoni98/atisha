...
//           console.log("Fetched student traits:", traits); // Log fetched traits
//           console.log("Fetched student traits:", traits.traits_counter); // Log fetched traits
//       } catch (err) {
...
const StudentOnboarding = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <motion.header 
        className="bg-white bg-opacity-90 backdrop-blur-md shadow-md"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        transition={{ duration: 0.5 }}
      >
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav>
            <Link to="/profile" className="text-gray-600 hover:text-gray-800 transition-colors">Profile</Link>
          </nav>
        </div>
      </motion.header>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <CareerFlowStep icon={<CheckCircle2 className="w-10 h-10 text-indigo-600" />} title="Take your Quiz" />
            <CareerFlowStep icon={<Target className="w-10 h-10 text-indigo-600" />} title="Explore Recommended Careers" />
            <CareerFlowStep icon={<BookOpen className="w-10 h-10 text-indigo-600" />} title="Explore Roadmaps" />
            <CareerFlowStep icon={<Users className="w-10 h-10 text-indigo-600" />} title="Complete Levels" />
            <CareerFlowStep icon={<Rocket className="w-10 h-10 text-indigo-600" />} title="Learn and Grow" isLast />
          </div>
        </motion.div>
