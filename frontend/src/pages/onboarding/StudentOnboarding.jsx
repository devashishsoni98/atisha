    ...
    switch (roleType) {
      case 'institute':
        return {
          ...
          description: "As an educational institute, you play a crucial role in shaping futures. Let's work together to create impactful programs and guide students towards success.",
      ...
      case 'counselor':
        return {
          ...
          description: "Your expertise can change lives. Prepare to inspire, mentor, and help students navigate their career journeys with confidence.",
      ...
      case 'mentor':
        return {
          ...
          description: "Your experience is invaluable. Get ready to mentor the next generation of professionals and help them reach their full potential.",
      ...
      default:
        return {
          ...
          description: "Exciting opportunities await! Let's explore your interests, skills, and dreams to chart the perfect career path for you.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
        ...
        >
          <div className="relative z-10 space-y-6 sm:space-y-8">
            <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-8">
              ...
              >
                <img src={welcomeContent.illustration} alt="Welcome Illustration" className="w-48 h-48 object-cover rounded-lg shadow-md" />
              </motion.div>
        ...
        >
          {[
            { title: "Personalized Learning", icon: <BookOpen className="w-8 h-8 text-blue-500" />, description: "Tailored courses and resources to match your goals and interests." },
            { title: "Expert Guidance", icon: <Users className="w-8 h-8 text-purple-500" />, description: "Connect with experienced mentors and counselors in your field." },
            { title: "Career Insights", icon: <Lightbulb className="w-8 h-8 text-yellow-500" />, description: "Gain valuable industry knowledge and stay ahead of trends." },
          ].map((feature, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
        ...
        {roleType === 'counselor' && (
          ...
          >
            <div className="relative z-10">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Counselor Training Program</h3>
              <p className="text-base text-gray-600 mb-6">Enhance your skills and stay updated with the latest in career counseling techniques and methodologies.</p>
              <Link
                to="/training"
      ...
      <footer className="bg-white bg-opacity-90 shadow-lg backdrop-blur-sm mt-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 text-center">
          <p className="text-sm text-gray-600">Need assistance? Reach out to our support team at support@careercompass.com</p>
        </div>
      </footer>
    </div>
  );
