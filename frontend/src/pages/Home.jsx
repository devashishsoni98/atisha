...
// import lines from "../assets/home.png";
// import illus2 from "../assets/line2.png";
// import illus3 from "../assets/line1.png";
...
//           <motion.h1 
//             className="text-5xl sm:text-7xl font-extrabold text-center mb-8"
//             variants={fadeInUp}
//           >
...
//             variants={fadeInUp}
//           >
//             Discover your perfect career path with AI-powered insights and expert guidance.
//           </motion.p>
//           <motion.div 
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-semibold mb-4">{feature.title}</h3>
                  <p className="text-gray-700">{feature.description}</p>
                  <Link to="#" className="mt-6 inline-flex items-center text-blue-600 font-semibold hover:text-blue-800 transition duration-300 ease-in-out group">
                    Learn More
                    <ArrowRight className="ml-2 w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" />
                  </Link>
                </div>
