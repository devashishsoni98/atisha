...
// import React, { useState } from 'react'
// import { User, Mail, Calendar, MapPin, Phone, School, GraduationCap, LogOut, BarChart } from 'lucide-react'
// import { Link } from 'react-router-dom'
...
//           <nav className="space-y-2">
//             {['Profile', 'Interest', 'Session', 'Activities', 'Insights'].map((tab) => (
//               <button
//                 key={tab}
//                 onClick={() => setActiveTab(tab)}
//                 className={`w-full py-3 px-4 rounded-xl text-left transition-colors ${
...
//   return (
//     <div className="space-y-6">
//       <h2 className="text-2xl font-bold text-blue-800">Student Insights</h2>
...
//                   <XAxis dataKey="month" />
//                   <YAxis />
//                   <Line type="monotone" dataKey="attendance" stroke="var(--color-attendance)" />
//                   <ChartTooltip content={<ChartTooltipContent />} />
//                 </LineChart>
//               </ResponsiveContainer>
//             </ChartContainer>
