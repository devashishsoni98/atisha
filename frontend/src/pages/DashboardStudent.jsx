...
//         className="min-h-screen bg-blue-50 flex items-center justify-center" {...fadeIn}>Loading...</motion.div>
//     if (error) return <motion.div
//         className="min-h-screen bg-blue-50 flex items-center justify-center" {...fadeIn}>Error: {error}</motion.div>
//     if (!studentData) return <motion.div
//         className="min-h-screen bg-blue-50 flex items-center justify-center" {...fadeIn}>No student data
...
// }
//
// export const ProfileItem = ({icon, label, value}) => {
//     return (
...
// }
//
// export const ProfileContent = ({studentData}) => {
...
// }
//
// export const InterestContent = ({interests}) => {
...
//                             whileTap={{scale: 0.95}}
//                         >
//                             <motion.h3 className="font-medium text-blue-700"
//                                        variants={fadeIn}>Subject {subjectId}</motion.h3>
//                         </motion.div>
//                     ))}
...
//                         >
//                             <motion.h3 className="font-medium text-blue-700"
//                                        variants={fadeIn}>Sport {sportId}</motion.h3>
//                         </motion.div>
//                     ))}
...
//                         >
//                             <motion.h3 className="font-medium text-blue-700"
//                                        variants={fadeIn}>Hobby {hobbyId}</motion.h3>
//                         </motion.div>
//                     ))}
//                 </div>
//             </motion.div>
...
//         <motion.div className="space-y-6" initial="initial" animate="animate" exit="exit" variants={fadeIn}>
//             <motion.div className="bg-white rounded-2xl p-6 shadow-md" variants={slideIn}>
//                 <motion.h2 className="text-2xl font-bold mb-6 text-blue-800" variants={fadeIn}>Book a Session today
//                 </motion.h2>
...
// }
//
// export const ActivitiesContent = ({activities}) => {
//     return (
//         <motion.div className="space-y-6" initial="initial" animate="animate" exit="exit" variants={fadeIn}>
//             <motion.div className="bg-white rounded-2xl p-6 shadow-md" variants={slideIn}>
//                 <motion.h2 className="text-2xl font-bold mb-6 text-blue-800" variants={fadeIn}>Your Activities
//                 </motion.h2>
//                 <motion.div className="space-y-4" variants={fadeIn}>
